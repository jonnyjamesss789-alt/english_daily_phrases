...
def generate_phrase():
    ...
    prompt = (
        ...
        "<b>Transcription:</b> <i>[Правильная транскрипция от носителя языка с транслитерацией русскими буквами. Можно использовать знаки ' для указания мягкости, двойные глассные буквы если звук длинный и так далее]</i>\n\n"
