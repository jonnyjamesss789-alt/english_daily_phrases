...
def generate_phrase():
    ...
    prompt = (
        ...
        "Смайл 🇺🇸<b>Phrase:</b> [Сама фраза]\n\n"
        
        "Смайл 🔊<b>Transcription:</b> [Правильная транскрипция от носителя языка с транслитерацией русскими буквами. Можно использовать знаки ' для указания мягкости, двойные глассные буквы если звук длинный и так далее]\n\n"
        
        "Смайл 🇷🇺<b>Translation:</b> [Перевод фразы]\n\n"
        
        "Смайл 📃<b>Context:</b> <i>[Объяснение на русском в 1-2 предложениях, когда это используется]</i>\n\n"
