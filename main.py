...
def generate_phrase():
    ...
    prompt = (
        ...
        "Используй HTML-теги. Обязательно делай двойные отступы между блоками. "
        "Формат ответа строго такой:\n\n"
        
        "🇬🇧 <b>Phrase:</b> [Сама фраза]\n\n"
        
        "🔊 <b>Transcription:</b> <code>[Транскрипция]\n\n"
        
        "🇷🇺 <b>Translation:</b> [Перевод фразы]\n\n"
        
        "📚 <b><i>Context:</b> [Объяснение на русском в 1-2 предложениях, когда это используется]</i>\n\n"
